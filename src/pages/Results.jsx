...
function Results() {
  ...
  //   limit: 20,
  //   market: 'ES',
  //   seed_artists: seedArtists.length > 0 ? seedArtists.join(',') : undefined,
  //   seed_genres: seedGenres.length > 0 ? seedGenres.join(',') : undefined,
  //   seed_tracks: seedSongs.length > 0 ? seedSongs.join(',') : undefined,
  ...
  const params = new URLSearchParams({
    limit: 20,
    market: 'ES',
    seed_tracks: "4lzrWjF6IgJr659sQteyyM",
  })
